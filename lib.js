...
module.exports = function(_nextTick) {
   if(typeof _nextTick !== 'function') {
      throw new Error('No function supplied to add to eventLoop');
   }
   ...
   function nsBind(args) {
      if(typeof process !== 'object' || process === null || typeof process.namespaces !== 'object' || process.namespaces === null) {
         return
      }
      var argKeys = Object.keys(args);
      var nsKeys = Object.keys(process.namespaces)
      ...
      for(var k=0;k<argKeys.length;++k) {
         for(var n=0;n<nsKeys.length;++n) {
            if(typeof args[argKeys[k]] === 'function') {
              ...
              try {
                // Streams
                process.namespaces[nsKeys[n]].bindEmitter(args[argKeys[k]]);
              } catch(err) {
                // Ignore
              }
            }
